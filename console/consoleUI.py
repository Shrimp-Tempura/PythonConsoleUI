...
class ConsolePYUI:
    ...
    def __printChoices(self, choiceIndex: int, choiceMenu: list):
    ...
    def askUserChoice(self, choiceMenu: list):
        ...
        while True:
            self.__printChoices(currentChoice, choiceMenu)
            key = input()
            os.system('clear')
...
while True:
    finalChoice = ConsolePYUI.askUserChoice(mainMenu)
    print(finalChoice)
    break
